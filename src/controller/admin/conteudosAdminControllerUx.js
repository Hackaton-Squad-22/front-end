import displayConteudosAdminUx from "../../service/conteudosAdmin/displayConteudosAdminUx.js";
...
window.addEventListener("DOMContentLoaded", async () => {
  ...
  const dados = await pesquisaConteudos(
    "https://squad22-hackathon.herokuapp.com/ux"
  );

  //Display dos conteudos na página
  displayConteudosAdminUx(dados);
